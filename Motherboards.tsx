...
function Motherboards(){
    return (<>
        <div className="row mt-4 mb-2"><h3>Motherboards</h3></div>
        <div className="row">
            <div className="col-sm-12">
                <div className="carousel slide" id="motherboards" data-ride="carousel" data-bs-wrap="false"  data-bs-touch="true">
                    ...
                    <button className="carousel-control-prev" type="button" data-bs-target="#motherboards" data-bs-slide="prev">
                        <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span className="visually-hidden">Previous</span>
                      </button>
                      <button className="carousel-control-next" type="button" data-bs-target="#motherboards" data-bs-slide="next">
